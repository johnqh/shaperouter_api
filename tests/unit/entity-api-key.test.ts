...
const personalKey = "shroute_abc123def456";

describe("entity-api-key", () => {
  describe("isEntityApiKeyFormat", () => {
    it("should accept a key with the shrouteent_ prefix", () => {
  ...
  describe("prefix isolation", () => {
    ...
    it("should keep the prefixes distinct", () => {
      expect(ENTITY_API_KEY_PREFIX).toBe("shrouteent");
      expect(ENTITY_API_KEY_PREFIX_WITH_SEPARATOR.startsWith("shroute_")).toBe(
        false
      );
    });
  });
